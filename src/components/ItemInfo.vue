<template>
  <Teleport to="#tovarBlock">
    <transition name="show">
      <div v-show="isVisible" class="absolute right-0 top-0 z-10 block">
        <div
          class="bg-style relative flex h-[500px] w-[250px] flex-col items-center rounded-r-xl border-l border-[#4d4d4d] px-[15px]"
        >
          <CloseIcon class="absolute right-2 top-2 cursor-pointer" @click="closeBlock" />
          <TovarItem
            width="115px"
            height="115px"
            :color="color"
          ...
          <div class="mt-[30px] border-y border-[#4d4d4d] pb-6 pt-3">
            <SkeletonItem width="211px" height="30px" borderRadius="8px" />
            <div class="mt-6 flex flex-col items-center gap-4">
              <SkeletonItem width="211px" height="10px" borderRadius="4px" />
              <SkeletonItem width="211px" height="10px" borderRadius="4px" />
              <SkeletonItem width="211px" height="10px" borderRadius="4px" />
              <SkeletonItem width="180px" height="10px" borderRadius="4px" />
              <SkeletonItem width="80px" height="10px" borderRadius="4px" />
            </div>
          </div>
          <button
